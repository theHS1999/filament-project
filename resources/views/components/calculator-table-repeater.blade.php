...
>
    ...
    <div {{ $attributes->merge($getExtraAttributes())->class([
        ...
        <div @class([
            'filament-table-repeater-container rounded-xl relative',
                ...
                <thead @class([
                    ...
                    <tr class="md:divide-x md:rtl:divide-x-reverse md:divide-gray-300 dark:md:divide-gray-700 text-sm">
                        @foreach ($headers as $key => $header)
                            <th
                                @class([
                                    'filament-table-repeater-header-column px-3 py-2 font-medium text-left text-gray-600 dark:text-gray-300',
                        ...
                        @endforeach
                        @if ($hasActions)
                            <th class="filament-table-repeater-header-column p-2 dark:bg-gray-900/60 w-px ltr:rounded-tr-xl rtl:rounded-tl-xl">
